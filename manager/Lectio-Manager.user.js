        ...
        root.innerHTML = `
            ...
            <div id="lectio-manager-panel" hidden>
                <div class="lectio-manager-header">
                    ...
                    <button type="button" class="lectio-manager-channel-btn" title="Stable / Unstable channel" aria-label="Stable / Unstable channel" aria-haspopup="true" aria-expanded="false">${settingsSvg()}</button>
                ...
                <div class="lectio-manager-channel-panel" hidden>
                    <div class="lectio-manager-channel-title">Release channel</div>
